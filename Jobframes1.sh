...
####srun --export=ALL python TrnTst_DeepPhys.py -p './myoutframesinface_20P2minto1min_filteredclean_derstd.csv' -m 'myfiltclean_derstd_20P_2minto1min_CorrectedFramesinfacenormsbest_allcorrboth_e48_1.0lr_adel_bvp_Itrbicu.pt' -lr 1.0 -e 48 -opt 'Adadelta'
####srun --export=ALL python TrnTst_DeepPhys_cohface.py -p './myoutcohfaceframesinface_37P2minto1min_clean_derstd.csv' -m 'cohface_clean_derstd_37P_2minto1min_CorrectedFramesinfacenormsbest_allcorrboth_e48_1.0lr_adel_bvp_Itrbicu.pt' -lr 1.0 -e 48 -opt 'Adadelta'